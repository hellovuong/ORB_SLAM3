...
bool Initializer::InitializeWithOdom(const Frame &CurrentFrame, const vector<int> &vMatches12, cv::Mat &R21, cv::Mat &t21,
                             vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated)
{
...
bool Initializer::ReconstructWithOdom(vector<bool> &vbMatchesInliers, cv::Mat &K, cv::Mat &R21, cv::Mat &t21,
